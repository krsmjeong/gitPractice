...
//                Uri uri = Uri.fromFile(tempFile);
                Log.d(TAG, "commit3_branc: " + uri);
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                ...
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit3_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit3_branc: " + tempFile);
                Log.d(TAG, "commit3_branc: " + BuildConfig.APPLICATION_ID);
