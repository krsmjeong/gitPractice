...
//                Uri uri = Uri.fromFile(tempFile);
                Log.d(TAG, "commit4_branc: " + uri);
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                ...
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit4_branc: " + getExternalCacheDir());
                Log.d(TAG, "commit4_branc: " + tempFile);
                Log.d(TAG, "commit4_branc: " + BuildConfig.APPLICATION_ID);
